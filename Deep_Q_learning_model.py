...
class DeepQNetwork(nn.Module):
    def __init__(self, lr, input_dims, fc1_dims, fc2_dims, n_actions):
        ...
        self.fc1 = nn.Linear(np.prod(input_dims), fc1_dims)
        self.fc2 = nn.Linear(fc1_dims, fc2_dims)
        self.fc3 = nn.Linear(fc2_dims, n_actions)

        # Optimizer and loss function can be defined here or in the training script
        self.optimizer = T.optim.Adam(self.parameters(), lr=lr)
        self.loss = nn.MSELoss()

        # This device check will help in using GPU if available
...
class Agent():
    def __init__(self, gamma, epsilon, lr, input_dims, batch_size, n_actions, max_mem_size, eps_end, eps_dec,eps_remover):
        self.gamma = gamma
    ...
    def store_transition(self, state, action, reward, state_, terminal):
        ...
        self.mem_cntr += 1
        self.mem_size = min(self.mem_size + 1, self.max_mem_size)
    ...
    def learn(self,game_count):
        ...
        if game_count < self.eps_remover:
